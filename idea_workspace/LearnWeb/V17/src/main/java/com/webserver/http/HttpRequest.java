...
public class HttpRequest {
    ...
    /**
     * 存抽象路径中的请求部分,即:uri中?左侧的内容
     */
    private String requestURI;
    /**
     * 存抽象路径中的参数部分,即:uri中?右侧部分
     */
    ...
    private void parseUri() {
        ...
        /*
            ...
            2:再将queryString部分按照"&"拆分出每一组参数,然后每一组参数再按照"="拆分为
        ...
        if (uri.contains("?")) {
            ...
            if (data.length > 1) {
                queryString = data[1];
                //username=facq&password=123456&nickname=chuanqi&age=22
     ...
     * GET形式和POST形式提交表单时,部分参数都是这个格式,因此解析操作被当前方法重用
     * @param line
     */
